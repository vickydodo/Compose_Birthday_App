        ...
        setContent {
            ComposeApplicationTheme {
                ...
                Surface(
                    ...
                    GreetingImage(
                        stringResource(R.string.happy_birthday_victor),
                        stringResource(R.string.from_isokpehi)
                    )
...
fun BirthdayCardPreview() {
    ComposeApplicationTheme {
        GreetingImage(stringResource(R.string.happy_birthday_victor), stringResource(R.string.from_isokpehi))
    }
}